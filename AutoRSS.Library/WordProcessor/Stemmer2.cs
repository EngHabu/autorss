...
namespace AutoRSS.Library.WordProcessor
{
    ...
    */
    ...
    public class PorterStemmer
    {
        ...
        private Dictionary<string, string> _cachedWords = new Dictionary<string, string>();
        ...
        */
        ...
        {
            string stemmed;
            if (_cachedWords.TryGetValue(word, out stemmed))
            {
                return stemmed;
            }
            ...
            i = b.Length;
            stem();
            return _cachedWords[word] = ToString();
        }
        ...
        public string[] StemWords(string[] words)
        {
            ...
            foreach (string word in words)
            {
                result.Add(StemWord(word.ToLowerInvariant()));
            }
